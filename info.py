...
API_ID = int(environ.get('API_ID', '27732828'))
API_HASH = environ.get('API_HASH', '1586630ea98d2393f7feb51cb84c3121')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002468078982').split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Rathore")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'loot')
